...
const search = async (query, database) => {
    ...
    if (database === "mongo" || database === "both") {
        results.push([
            { name: "Mongo 1", description: "This is item 1", image: "https://game-icons.net/icons/ffffff/000000/1x1/delapouite/sea-urchin.svg" },
            { name: "Mongo 2", description: "This is item 2", image: "https://game-icons.net/icons/ffffff/000000/1x1/delapouite/sea-urchin.svg" },
